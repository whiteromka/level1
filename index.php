...
// которые проверяют базовые знания по языку (встренные функции, циклы, условия итд). Очень желательно каждый день решать по 1-ой задаче. Я просто попорядку все решал в свое время.
...
// Функция на выходе должна отдавать отсотированный по алфавиту массив инверитрованных имен.
// Т.е. сначало нужно инвертировать все имена.
// Потом отсортировать в алфавитном порядке получившийся массив (google в помощь!)
// Используюете контроль типов при описанни функции и phpDock

// 3.2
// - Возовите эту функцию в файле "index.php", предварительно подключив файл "myFuncs.php" в "index.php"
